...
export default function renderNode(props, _editor, next) {
    var attributes = props.attributes, children = props.children, _a = props.node, type = _a.type, data = _a.data;
    switch (type) {
        case 'paragraph':
        ...
        case 'link': {
            ...
            return (<a {...attributes} href={href} title={title}>
          {children}
        </a>);
        }
        case 'image': {
        ...
        case 'embed': {
          ...
          <iframe 
            ...
            title={src} src={src} allowFullScreen frameBorder="0" width="420" height="315" style={{
                left: 0,
                top: 0,
                height: '100%',
                width: '100%',
